    ...
    <div className="w-screen overflow-x-scroll text-red-500">
      ...
      <div className="w-max flex">
        ...
        <div key={item.id} className="w-screen h-[60vh] flex flex-col items-center justify-around p-4 hover:bg-fuchsia-50 transition-all duration-300 md:w-[50vw] xl:w-[33vw] xl:h-[90vh]">
          <div className="relative flex-1 w-full hover:rotate-[60deg] transition-all duration-500">{/* IMAGE CONTAINER */}
          {item.img && <Image src={item.img} alt="Image" fill className="object-contain" />}
          </div>
          <div className="flex-1 flex flex-col items-center justify-center text-center gap-4">{/* TEXT CONTAINER */}
